...
* **macOS** — правий клік на програмі → **Відкрити** (звичайний подвійний клік Gatekeeper
  заблокує). Або в терміналі: `xattr -dr com.apple.quarantine /Applications/dndsound.app`
